...
program
  .name("aperio")
  .description("Aperio command-line client — signs Aperio and Bulletin txs with a user-provided key.")
  .version("0.1.0");
...
program
  ...
  .description("Upload a Git bundle to Bulletin and register the repository on the Aperio registry.")
